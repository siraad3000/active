...
function Startsida({ challenges }: Props) {
  ...
  return (
    <div className="bg-gradient-to-t from-active-bluelight via-active-purplelight to-active-goldlight min-h-screen ">
      <Head>
      ...
      <main>
        ...
        <ChallengeForm onSubmitChallenge={handleChallengeSubmit} />
        {/* Display challenges component */}
        <DisplayChallenges challenges={challengeList} className="pt-28 pb-36" />
        <div id="footer">
          <FooterNavbar />
        </div>
      </main>
